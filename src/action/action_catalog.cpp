...
const std::map<ActionToolID, ActionCatalogItem> action_catalog = {
        ...
        {ToolID::DRAW_ARC_3_POINT, {"Draw 3-point arc", ActionGroup::DRAW, ActionCatalogItem::FLAGS_DEFAULT}},
        {ToolID::DRAW_ARC_CENTER_POINT,
         {"Draw center-point arc", ActionGroup::DRAW, ActionCatalogItem::FLAGS_DEFAULT}},
        {ToolID::DRAW_ARC_TANGENT, {"Draw tangent arc", ActionGroup::DRAW, ActionCatalogItem::FLAGS_DEFAULT}},
        ...
        {ToolID::DRAW_CIRCLE_2_POINT,
         {"Draw 2-point circle", ActionGroup::DRAW, ActionCatalogItem::FLAGS_DEFAULT}},
        {ToolID::DRAW_CIRCLE_3_POINT,
         {"Draw 3-point circle", ActionGroup::DRAW, ActionCatalogItem::FLAGS_DEFAULT}},
        {ToolID::DRAW_CIRCLE_2_TANGENT,
         {"Draw 2-tangent circle", ActionGroup::DRAW, ActionCatalogItem::FLAGS_DEFAULT}},
        {ToolID::DRAW_CIRCLE_3_TANGENT,
         {"Draw 3-tangent circle", ActionGroup::DRAW, ActionCatalogItem::FLAGS_DEFAULT}},
        {ToolID::DRAW_SLOT_CENTER_TO_CENTER,
         {"Draw center-to-center slot", ActionGroup::DRAW, ActionCatalogItem::FLAGS_DEFAULT}},
        {ToolID::DRAW_SLOT_OVERALL, {"Draw overall slot", ActionGroup::DRAW, ActionCatalogItem::FLAGS_DEFAULT}},
        {ToolID::DRAW_SLOT_CENTER_POINT,
         {"Draw center-point slot", ActionGroup::DRAW, ActionCatalogItem::FLAGS_DEFAULT}},
        {ToolID::DRAW_SLOT_3_POINT_ARC,
         {"Draw 3-point arc slot", ActionGroup::DRAW, ActionCatalogItem::FLAGS_DEFAULT}},
        {ToolID::DRAW_SLOT_CENTER_POINT_ARC,
         {"Draw center-point arc slot", ActionGroup::DRAW, ActionCatalogItem::FLAGS_DEFAULT}},
        {ToolID::PROJECT_SKETCH_GEOMETRY,
         {"Project sketch geometry", ActionGroup::DRAW, ActionCatalogItem::FLAGS_DEFAULT}},
        {ToolID::DRAW_ELLIPSE, {"Draw ellipse", ActionGroup::DRAW, ActionCatalogItem::FLAGS_DEFAULT}},
        {ToolID::DRAW_CONIC_CURVE, {"Draw conic curve", ActionGroup::DRAW, ActionCatalogItem::FLAGS_DEFAULT}},
        ...
        {ToolID::MEASURE_LENGTH_RATIO,
         {"Measure length ratio", ActionGroup::MEASURE, ActionCatalogItem::FLAGS_DEFAULT}},
        ...
        {ToolID::IMPORT_STL, {"Import Mesh", ActionGroup::UNKNOWN, ActionCatalogItem::FLAGS_DEFAULT}},
        ...
        {ActionID::TOGGLE_SHOW_ONLY_SOLID_MODEL,
         {"Toggle show only solid models", ActionGroup::VIEW, ActionCatalogItem::FLAGS_IN_TOOL}},
        ...
        {ActionID::CREATE_GROUP_LOFT, {"Create loft group", ActionGroup::GROUP, ActionCatalogItem::FLAGS_DEFAULT}},
        ...
        {ToolID::DRAW_RECTANGLE_CENTER,
         {"Draw center rectangle", ActionGroup::DRAW, ActionCatalogItem::FLAGS_DEFAULT}},
        {ToolID::DRAW_RECTANGLE_3_POINT,
         {"Draw 3-point rectangle", ActionGroup::DRAW, ActionCatalogItem::FLAGS_DEFAULT}},
        ...
        {ToolID::CREATE_COMPONENT,
         {"New component from current body", ActionGroup::UNKNOWN, ActionCatalogItem::FLAGS_DEFAULT}},
        {ToolID::INSERT_OCCURRENCE, {"Insert occurrence", ActionGroup::UNKNOWN, ActionCatalogItem::FLAGS_DEFAULT}},
        {ToolID::NEW_COMPONENT, {"New component", ActionGroup::UNKNOWN, ActionCatalogItem::FLAGS_DEFAULT}},
        ...
        {ToolID::SKETCH_FILLET, {"Sketch fillet", ActionGroup::DRAW, ActionCatalogItem::FLAGS_DEFAULT}},
        {ToolID::SKETCH_CHAMFER, {"Sketch chamfer", ActionGroup::DRAW, ActionCatalogItem::FLAGS_DEFAULT}},
...
const LutEnumStr<ActionID> action_lut = {
        ...
        ACTION_LUT_ITEM(TOGGLE_SHOW_ONLY_SOLID_MODEL),
        ...
        ACTION_LUT_ITEM(CREATE_GROUP_LOFT),
...
const LutEnumStr<ToolID> tool_lut = {
        ...
        TOOL_LUT_ITEM(DRAW_ARC_3_POINT),
        TOOL_LUT_ITEM(DRAW_ARC_CENTER_POINT),
        TOOL_LUT_ITEM(DRAW_ARC_TANGENT),
        TOOL_LUT_ITEM(DRAW_BEZIER_2D),
        TOOL_LUT_ITEM(DRAW_LINE_2D),
        TOOL_LUT_ITEM(DRAW_POINT_2D),
        TOOL_LUT_ITEM(DRAW_CIRCLE_2D),
        TOOL_LUT_ITEM(DRAW_CIRCLE_2_POINT),
        TOOL_LUT_ITEM(DRAW_CIRCLE_3_POINT),
        TOOL_LUT_ITEM(DRAW_CIRCLE_2_TANGENT),
        TOOL_LUT_ITEM(DRAW_CIRCLE_3_TANGENT),
        TOOL_LUT_ITEM(DRAW_SLOT_CENTER_TO_CENTER),
        TOOL_LUT_ITEM(DRAW_SLOT_OVERALL),
        TOOL_LUT_ITEM(DRAW_SLOT_CENTER_POINT),
        TOOL_LUT_ITEM(DRAW_SLOT_3_POINT_ARC),
        TOOL_LUT_ITEM(DRAW_SLOT_CENTER_POINT_ARC),
        TOOL_LUT_ITEM(PROJECT_SKETCH_GEOMETRY),
        TOOL_LUT_ITEM(DRAW_ELLIPSE),
        TOOL_LUT_ITEM(DRAW_CONIC_CURVE),
        ...
        TOOL_LUT_ITEM(MEASURE_LENGTH_RATIO),
        ...
        TOOL_LUT_ITEM(DRAW_RECTANGLE_CENTER),
        TOOL_LUT_ITEM(DRAW_RECTANGLE_3_POINT),
        ...
        TOOL_LUT_ITEM(CREATE_COMPONENT),
        TOOL_LUT_ITEM(INSERT_OCCURRENCE),
        TOOL_LUT_ITEM(NEW_COMPONENT),
        TOOL_LUT_ITEM(DRAW_TEXT),
        TOOL_LUT_ITEM(SKETCH_FILLET),
        TOOL_LUT_ITEM(SKETCH_CHAMFER),
