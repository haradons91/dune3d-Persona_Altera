...
private:
    ...
    void visit(const EntitySTL &step) override;
    void visit(const EntityThreeMF &step) override;
    ...
    void visit(const EntityPicture &point) override;
    void visit(const EntityOccurrence &occurrence) override;
    ...
    void add_replicate(const GroupReplicate &group, CreateEq create_eq2, CreateEq create_eq3, CreateEqN create_eq_n,
                       unsigned int &eqi);
